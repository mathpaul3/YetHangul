...
- 입력 파이프라인 refactor는 `docs/architecture/input-pipeline-refactor.md`를 spec-first source of truth로 둔다.
...
- 이 원칙의 상세 정리는 `docs/architecture/input-pipeline.md`를 source of truth로 둔다.
